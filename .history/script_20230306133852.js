...
// API Data 
const categories = fetch('../testData/categories').then(res => res.json())
const products = fetch('../testData/products').then(res => res.json())
const subCategories = fetch('../testData/subCategories').then(res => res.json())
