...
// API Data 
const categories = fetch('../testData/categories.js').then(res => res.json())
const products = fetch('../testData/products.js').then(res => res.json())
const subCategories = fetch('../testData/subCategories.js').then(res => res.json())
