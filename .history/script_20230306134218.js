...
// API Data 
const categories = fetch('../testData/categories.json').then(res => res.json())
const products = fetch('../testData/products.json').then(res => res.json())
const subCategories = fetch('../testData/subCategories.json').then(res => res.json())
