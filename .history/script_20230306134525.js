...
// API Data 
let jsonReturn = []
const categories = JSON.parse(fetch('../testData/categories.json').then(res => jsonReturn => res.json()))
const products = JSON.parse(fetch('../testData/products.json').then(res => jsonReturn => res.json()))
const subCategories = JSON.parse(fetch('../testData/subCategories.json').then(res => jsonReturn => res.json()))
