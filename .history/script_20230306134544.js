...
// API Data 
let jsonReturn = []
const categories = fetch('../testData/categories.json').then(res => jsonReturn => res.json())
const products = fetch('../testData/products.json').then(res => jsonReturn => res.json())
const subCategories = fetch('../testData/subCategories.json').then(res => jsonReturn => res.json())
