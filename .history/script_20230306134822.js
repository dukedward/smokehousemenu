...
// API Data 
let jsonReturn = []
const categories = fetch('../testData/categories.json').then(res => jsonReturn => res.json()).then(val=> val)
const products = fetch('../testData/products.json').then(res => jsonReturn => res.json()).then(val=> val)
const subCategories = fetch('../testData/subCategories.json').then(res => jsonReturn => res.json()).then(val=> val)
