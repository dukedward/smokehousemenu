...
// API Data 
let jsonReturn = []
const categories = fetch('../testData/categories.json').then(res => res.text())
const products = fetch('../testData/products.json').then(res => res.text())
const subCategories = fetch('../testData/subCategories.json').then(res => res.text())
