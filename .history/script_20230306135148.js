...
// API Data 
let jsonReturn = []
const categories = fetch('../testData/categories.json').then(res => res.json()).then(res => JSON.stringify(res))
const products = fetch('../testData/products.json').then(res => res.json()).then(res => JSON.stringify(res))
const subCategories = fetch('../testData/subCategories.json').then(res => res.json()).then(res => JSON.stringify(res))
