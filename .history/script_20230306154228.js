...
const categories = await fetchJSON('../testData/categories.json')
const products = await fetchJSON('../testData/products.json')
const subCategories = await fetchJSON('../testData/subCategories.json')
