...
categories = fetchJSON('../testData/categories.json', categories)
products = fetchJSON('../testData/products.json', products)
subCategories = fetchJSON('../testData/subCategories.json', subCategories)
