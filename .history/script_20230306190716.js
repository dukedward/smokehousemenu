...
// console.log();
let categories, subCategories, products, data;
...
function getInfo(path, output) { 
    fetch(path, {headers: {'Authorization':'Client-ID edace9dee9010a3'}})
    .then(function(res){
        console.log(res);
        return res.json()
    })
...
getInfo('../testData/categories.json', categories)
